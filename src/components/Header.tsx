        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div ref={marksRef} className="relative">
              <button
                ...
                className="flex items-center text-gray-700 hover:text-green-600 transition-colors focus:outline-none"
          ...
          <div ref={languageRef} className="relative">
            <button
              ...
              className="flex items-center bg-gray-100 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 transition-colors focus:outline-none"
          ...
          <div className="flex items-center space-x-4 md:hidden">
            ...
            >
              <div className="w-6 h-6 flex flex-col justify-center items-center">
                ...
                ></span>
                <span
                  className={`block w-5 h-0.5 bg-gray-600 mt-1 transition-all ${
